...
MapPoint::MapPoint():
    ...
    mpReplaced(static_cast<MapPoint*>(NULL)), mfMinDistance(0), mfMaxDistance(0),flag_global_map(false)
 { 
...
MapPoint::MapPoint(const cv::Mat &Pos, KeyFrame *pRefKF, Map* pMap):
    ...
    mpReplaced(static_cast<MapPoint*>(NULL)), mfMinDistance(0), mfMaxDistance(0), mpMap(pMap),flag_global_map(false)
{
...
MapPoint::MapPoint(const cv::Mat &Pos, Map* pMap, Frame* pFrame, const int &idxF):
    ...
    mnFound(1), mbBad(false), mpReplaced(NULL), mpMap(pMap),flag_global_map(false)
{
    Pos.copyTo(mWorldPos);
...
void MapPoint::SetGlobalMapFlag(bool is_global_map)
{
    flag_global_map = is_global_map;
}

bool MapPoint::GetGlobalMapFlag()
{
